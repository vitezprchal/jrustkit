        ...
        while i < code_length {
            ...
            match opcode {
                ...
                ASTORE | DSTORE | FSTORE | ISTORE | LSTORE => {
                    ...
                    instructions.
                        push(Instruction::new(opcode, InstructionType::Variable {
                            index,
                        }));
                ...
                ALOAD_0 | ALOAD_1 | ALOAD_2 | ALOAD_3 => {
                    ...
                    instructions.push(Instruction::new(ALOAD, InstructionType::Variable {
                        index,
                    }));
                }
                ...
                DLOAD_0 | DLOAD_1 | DLOAD_2 | DLOAD_3 => {
                    ...
                    instructions.push(Instruction::new(DLOAD, InstructionType::Variable {
                        index,
                    }));
                }
                FLOAD_0 | FLOAD_1 | FLOAD_2 | FLOAD_3 => {
                    let index = opcode - FLOAD_0;
                    instructions.push(Instruction::new(FLOAD, InstructionType::Variable {
                        index,
                    }));
                }
                ILOAD_0 | ILOAD_1 | ILOAD_2 | ILOAD_3 => {
                    let index = opcode - ILOAD_0;
                    instructions.push(Instruction::new(ILOAD, InstructionType::Variable {
                        index,
                    }));
                }
                LLOAD_0 | LLOAD_1 | LLOAD_2 | LLOAD_3 => {
                    let index = opcode - LLOAD_0;
                    instructions.push(Instruction::new(LLOAD, InstructionType::Variable {
                        index,
                    }));
                }
                ...
                DSTORE_0 | DSTORE_1 | DSTORE_2 | DSTORE_3 => {
                    ...
                    instructions.push(Instruction::new(DSTORE, InstructionType::Variable {
                        index,
                    }));
                }
                FSTORE_0 | FSTORE_1 | FSTORE_2 | FSTORE_3 => {
                    let index = opcode - FSTORE_0;
                    instructions.push(Instruction::new(FSTORE, InstructionType::Variable {
                        index,
                    }));
                }
                ISTORE_0 | ISTORE_1 | ISTORE_2 | ISTORE_3 => {
                    let index = opcode - ISTORE_0;
                    instructions.push(Instruction::new(ISTORE, InstructionType::Variable {
                        index,
                    }));
                }
                LSTORE_0 | LSTORE_1 | LSTORE_2 | LSTORE_3 => {
                    let index = opcode - LSTORE_0;
                    instructions.push(Instruction::new(LSTORE, InstructionType::Variable {
                        index,
                    }));
                }
                ASTORE_0 | ASTORE_1 | ASTORE_2 | ASTORE_3 => {
                    let index = opcode - ASTORE_0;
                    instructions.push(Instruction::new(ASTORE, InstructionType::Variable {
                        index,
                    }));
                }
                BIPUSH => {
                    ...
                    instructions.
                        push(Instruction::new(BIPUSH, InstructionType::Bipush { byte }));
                    i += 1;
                }
                CHECKCAST => {
                    let index = reader.read_u2();
                    instructions.
                        push(Instruction::new(CHECKCAST, InstructionType::Checkcast { index }));
                    i += 2;
                }
                GETFIELD | GETSTATIC | PUTFIELD | PUTSTATIC => {
                    let index = reader.read_u2();
                    instructions.push(Instruction::new(opcode, InstructionType::Field {
                        index,
                    }));
                ...
                | INVOKESTATIC | INVOKEVIRTUAL => {
                    let index = reader.read_u2();
                    instructions.push(Instruction::new(opcode, InstructionType::Invoke {
                        index,
                    }));
                ...
                LDC => {
                    let index = reader.read_u1();
                    instructions.push(Instruction::new(LDC, InstructionType::Ldc {
                        index,
                    }));
                ...
                ANEWARRAY => {
                    let index = reader.read_u2();
                    instructions.push(Instruction::new(ALOAD, InstructionType::Anewarray {
                        index,
                    }));
